...
public interface UserRepository extends JpaRepository<User, Long>, JpaSpecificationExecutor<User> {
	...
	public void updateUserToken(@Param("token") String token, @Param("tokenDate") Date tokenDate,
			@Param("userId") Long userId);

	@Query("select us from UserStatus us  where us.code = :code")
	public UserStatus getStatusByCode(@Param("code") String code);
